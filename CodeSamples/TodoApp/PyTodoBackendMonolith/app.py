...
connection_string = "Driver={ODBC Driver 17 for SQL Server};Server=tcp:ghatak.database.windows.net,1433;Database=ghatakdb;Uid=devopsadmin;Pwd=P@ssw01rd@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
